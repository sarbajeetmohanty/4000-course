...
export const TopBar = () => {
  ...
  return (
    <div className="bg-[#111322] text-white py-2 sm:py-3 px-2 sm:px-4 w-full sticky top-0 z-50 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-6 shadow-md">
